...
yyyymmdd <- "20230526"
pH_row <- "pH4_" # new entry, change for each pH

# Read in the plate template
folder_path <- file.path(paste0("data/", yyyymmdd, "/"))
file_path <- list.files(folder_path, pattern = "20230526_Template_pH4_optimum_LBamidase_4NPproduct_410nm_347nm", full.names = T)
